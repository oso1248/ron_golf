...
!(function (e, t) {
  ...
  (t.prototype.createHeadersElement = function () {
    ...
    (t.prototype.scrollHorizontal = function (e) {
      ...
      (this.element.scrollLeft = e),
        e > o ? ((t = e - o), (this.element.style.marginLeft = -t + 'px')) : (this.element.style.marginLeft = 0),
        (this.scrollLeft = e),
    ...
    (t.prototype.getDefinitions = function (e) {
      var t = this,
        o = [];
      return (
        t.columnsByIndex.forEach(function (t) {
    ...
    (t.prototype.getComponents = function (e) {
      var t = this,
        o = [];
      return (
        (e ? t.columns : t.columnsByIndex).forEach(function (e) {
    ...
    (t.prototype.scrollToColumn = function (e, t, o) {
      ...
      return new Promise(function (l, c) {
        if ((void 0 === t && (t = i.table.options.scrollToColumnPosition), void 0 === o && (o = i.table.options.scrollToColumnIfVisible), e.visible)) {
          ...
          (n = r.offsetLeft + i.element.scrollLeft + a),
    ...
    (t.prototype.getFlexBaseWidth = function () {
      var e = this,
        ...
        o = 0;
      return (
        e.rowManager.element.scrollHeight > e.rowManager.element.clientHeight && (t -= e.rowManager.element.offsetWidth - e.rowManager.element.clientWidth),
    ...
    (t.prototype.redraw = function (e) {
      e && (d.prototype.helpers.elVisible(this.element) && this._verticalAlignHeaders(), this.table.rowManager.resetScroll(), this.table.rowManager.reinitialize()),
        ['fitColumns', 'fitDataStretch'].indexOf(this.table.modules.layout.getMode()) > -1
  ...
  (n.prototype.createElement = function () {
    ...
    (n.prototype._mapDepricatedFunctionality = function () {
      void 0 !== this.definition.hideInHtml &&
        ((this.definition.htmlOutput = !this.definition.hideInHtml), console.warn('hideInHtml column definition property is deprecated, you should now use htmlOutput')),
        void 0 !== this.definition.align && ((this.definition.hozAlign = this.definition.align), console.warn('align column definition property is deprecated, you should now use hozAlign')),
        void 0 !== this.definition.downloadTitle &&
          ((this.definition.titleDownload = this.definition.downloadTitle), console.warn('downloadTitle definition property is deprecated, you should now use titleDownload'));
    }),
    (n.prototype.setTooltip = function () {
      ...
      o
        ? !0 === o
          ? t.field
            ? e.table.modules.localize.bind('columns|' + t.field, function (o) {
                e.element.setAttribute('title', o || t.title);
              })
            : e.element.setAttribute('title', t.title)
          : ('function' == typeof o && !1 === (o = o(e.getComponent())) && (o = ''), e.element.setAttribute('title', o))
    ...
    (n.prototype._buildHeader = function () {
      ...
      t.headerVertical && (e.element.classList.add('tabulator-col-vertical'), 'flip' === t.headerVertical && e.element.classList.add('tabulator-col-vertical-flip')),
        ...
        t.headerFilter &&
          ...
          (void 0 !== t.headerFilterPlaceholder && t.field && e.table.modules.localize.setHeaderFilterColumnPlaceholder(t.field, t.headerFilterPlaceholder),
      ...
      'function' == typeof n.headerClick &&
        ...
        'function' == typeof n.headerDblTap &&
          ...
          i.element.addEventListener('touchend', function (t) {
            e
              ? (clearTimeout(e), (e = null), n.headerDblTap(t, i.getComponent()))
    ...
    (n.prototype._buildColumnHeader = function () {
      var e = this,
        ...
        o = e.table;
      if (
        (o.modExists('sort') && o.modules.sort.initializeColumn(e, e.contentElement),
        (t.headerContextMenu || t.headerMenu) && o.modExists('menu') && o.modules.menu.initializeColumnHeader(e),
        o.modExists('format') && o.modules.format.initializeColumn(e),
        void 0 !== t.editor && o.modExists('edit') && o.modules.edit.initializeColumn(e),
        void 0 !== t.validator && o.modExists('validate') && o.modules.validate.initializeColumn(e),
        o.modExists('mutator') && o.modules.mutator.initializeColumn(e),
        o.modExists('accessor') && o.modules.accessor.initializeColumn(e),
        _typeof(o.options.responsiveLayout) && o.modExists('responsiveLayout') && o.modules.responsiveLayout.initializeColumn(e),
        void 0 !== t.visible && (t.visible ? e.show(!0) : e.hide(!0)),
        t.cssClass)
      ) {
      ...
      t.field && this.element.setAttribute('tabulator-field', t.field),
        e.setMinWidth(void 0 === t.minWidth ? e.table.options.columnMinWidth : parseInt(t.minWidth)),
        e.reinitializeWidth(),
        (e.tooltip = e.definition.tooltip || !1 === e.definition.tooltip ? e.definition.tooltip : e.table.options.tooltips),
        (e.hozAlign = void 0 === e.definition.hozAlign ? e.table.options.cellHozAlign : e.definition.hozAlign),
        (e.vertAlign = void 0 === e.definition.vertAlign ? e.table.options.cellVertAlign : e.definition.vertAlign);
    }),
    ...
    (n.prototype._formatColumnHeaderTitle = function (e, t) {
      ...
      if (this.definition.titleFormatter && this.table.modExists('format'))
        switch (
          ((o = this.table.modules.format.getFormatter(this.definition.titleFormatter)),
          (a = function (e) {
      ...
      (this.element.style.height = o + 'px'),
        ...
        this.isGroup ||
          ...
          (this.element.style.paddingTop =
            'bottom' === e ? this.element.clientHeight - this.contentElement.offsetHeight + 'px' : (this.element.clientHeight - this.contentElement.offsetHeight) / 2 + 'px'),
      ...
      return new Promise(function (o, i) {
        ...
        t.isGroup
          ? (console.warn('Column Update Error - The updateDefintion function is only available on columns, not column groups'),
            i('Column Update Error - The updateDefintion function is only available on columns, not column groups'))
  ...
  (s.prototype.createHolderElement = function () {
    ...
    (s.prototype.scrollToRow = function (e, t, o) {
      ...
      return new Promise(function (e, l) {
        if (s > -1) {
          ...
          if (!o && d.prototype.helpers.elVisible(a) && (r = d.prototype.helpers.elOffset(a).top - d.prototype.helpers.elOffset(n.element).top) > 0 && r < n.element.clientHeight - a.offsetHeight)
            return !1;
          switch (n.renderMode) {
            case 'classic':
          ...
          switch (t) {
            case 'middle':
            case 'center':
              n.element.scrollHeight - n.element.scrollTop == n.element.clientHeight
                ? (n.element.scrollTop = n.element.scrollTop + (a.offsetTop - n.element.scrollTop) - (n.element.scrollHeight - a.offsetTop) / 2)
                : (n.element.scrollTop = n.element.scrollTop - n.element.clientHeight / 2);
              break;
            case 'bottom':
              n.element.scrollHeight - n.element.scrollTop == n.element.clientHeight
                ? (n.element.scrollTop = n.element.scrollTop - (n.element.scrollHeight - a.offsetTop) + a.offsetHeight)
    ...
    (s.prototype.setData = function (e, t, o) {
      ...
      return new Promise(function (s, a) {
        t && i.getDisplayRows().length
          ...
          : (i.table.options.autoColumns && o && i.table.columnManager.generateColumnsFromRowData(e), i.resetScroll(), i._setDataActual(e)),
          s();
      });
    }),
    (s.prototype._setDataActual = function (e, t) {
      ...
      o.table.options.dataLoading.call(this.table, e),
        ...
        Array.isArray(e)
          ? (this.table.modExists('selectRow') && this.table.modules.selectRow.clearSelectionData(),
    ...
    (s.prototype.deleteRow = function (e, t) {
      ...
      i > -1 && this.activeRows.splice(i, 1),
        ...
        this.table.options.groupBy && this.table.modExists('groupRows')
          ...
          : this.table.options.pagination && this.table.modExists('page') && this.refreshActiveData('page');
    }),
    (s.prototype.addRow = function (e, t, o, i) {
      var n = this.addRowActual(e, t, o, i);
      return this.table.options.history && this.table.modExists('history') && this.table.modules.history.action('rowAdd', n, { data: e, pos: t, index: o }), n;
    }),
    ...
    (s.prototype.addRowActual = function (e, t, o, i) {
      var n,
        s,
        a = e instanceof r ? e : new r(e || {}, this),
      ...
      if (
        (!o &&
          ...
          l
            ? s.length
              ? (o = s[0])
              : this.activeRows.length && ((o = this.activeRows[this.activeRows.length - 1]), (l = !1))
            : s.length && ((o = s[s.length - 1]), (l = !(s.length < this.table.modules.page.getPageSize())))),
        ...
        u.length > 1 &&
          (!o || (o && -1 == u.indexOf(o))
            ? l
              ? u[0] !== a && ((o = u[0]), this._moveRowInArray(a.getGroup().rows, a, o, !l))
              : u[u.length - 1] !== a && ((o = u[u.length - 1]), this._moveRowInArray(a.getGroup().rows, a, o, !l))
            : this._moveRowInArray(a.getGroup().rows, a, o, !l));
      }
      return (
        o && (c = this.rows.indexOf(o)),
        o && c > -1
          ? ((n = this.activeRows.indexOf(o)),
            ...
            n > -1 && this.activeRows.splice(l ? n : n + 1, 0, a),
            this.rows.splice(l ? c : c + 1, 0, a))
          : l
          ? (this.displayRowIterator(function (e) {
              e.unshift(a);
            }),
    ...
    (s.prototype.moveRow = function (e, t, o) {
      this.table.options.history &&
        ...
        this.table.modules.history.action('rowMove', e, { posFrom: this.getRowPosition(e), posTo: this.getRowPosition(t), to: t, after: o }),
    ...
    (s.prototype.sorterRefresh = function (e) {
      var t = this.table,
        ...
        i = this.scrollLeft;
      o.ajaxSorting
        ? ('remote' == o.pagination || o.progressiveLoad) && t.modExists('page')
    ...
    (s.prototype.refreshActiveData = function (e, t, o) {
      var i,
        n = this,
        s = this.table,
        a = ['all', 'filter', 'sort', 'display', 'freeze', 'group', 'tree', 'page'];
      if (this.redrawBlock)
        return void (
          (!this.redrawBlockRestoreConfig || a.indexOf(e) < a.indexOf(this.redrawBlockRestoreConfig.stage)) &&
          (this.redrawBlockRestoreConfig = { stage: e, skipStage: t, renderInPosition: o })
        );
      switch (
        ...
        case 'freeze':
          t
            ...
            : this.table.modExists('frozenRows') &&
              s.modules.frozenRows.isFrozen() &&
              (s.modules.frozenRows.getDisplayIndex() || s.modules.frozenRows.setDisplayIndex(this.getNextDisplayIndex()),
        ...
        case 'group':
          t
            ? (t = !1)
            : s.options.groupBy &&
              s.modExists('groupRows') &&
              (s.modules.groupRows.getDisplayIndex() || s.modules.groupRows.setDisplayIndex(this.getNextDisplayIndex()),
        ...
        case 'tree':
          t
            ? (t = !1)
            : s.options.dataTree &&
              s.modExists('dataTree') &&
              (s.modules.dataTree.getDisplayIndex() || s.modules.dataTree.setDisplayIndex(this.getNextDisplayIndex()),
        ...
        case 'page':
          t
            ...
            : s.options.pagination &&
              s.modExists('page') &&
              (s.modules.page.getDisplayIndex() || s.modules.page.setDisplayIndex(this.getNextDisplayIndex()),
      ...
      d.prototype.helpers.elVisible(n.element) && (o ? n.reRenderInPosition() : (n.renderTable(), s.options.layoutColumnsOnNewData && n.table.columnManager.redraw(!0))),
    ...
    (s.prototype.setDisplayRows = function (e, t) {
      var o = !0;
      return (
        t && void 0 !== this.displayRows[t] ? ((this.displayRows[t] = e), (o = !0)) : (this.displayRows.push(e), (o = t = this.displayRows.length - 1)),
        ...
        for (var r = this.vDomTop; r <= this.vDomBottom; r++)
          if (a[r])
            if (i) {
              ...
              s = r;
            } else if (t - a[r].getElement().offsetTop >= 0) n = r;
            else {
    ...
    (s.prototype.reRenderInPosition = function (e) {
      if ('virtual' == this.getRenderMode())
        if (this.redrawBlock) e ? e() : (this.redrawBlockRederInPosition = !0);
        else {
    ...
    (s.prototype.setRenderMode = function () {
      this.table.options.virtualDom
        ? ((this.renderMode = 'virtual'), this.table.element.clientHeight || this.table.options.height ? (this.fixedHeight = !0) : (this.fixedHeight = !1))
      ...
      if (i.displayRowsCount && d.prototype.helpers.elVisible(i.element)) {
        for (i.vDomTop = e, i.vDomBottom = e - 1; (r <= i.height + i.vDomWindowBuffer || c < i.vDomWindowMinTotalRows) && i.vDomBottom < i.displayRowsCount - 1; ) {
          ...
          i.styleRow(f, m),
            ...
            f.initialized ? f.heightInitialized || f.normalizeHeight(!0) : f.initialize(!0),
            (g = f.getHeight()),
            c < a ? (l += g) : (r += g),
        ...
        e
          ? ((i.vDomTopPad = t ? i.vDomRowHeight * this.vDomTop + o : i.scrollTop - l),
            (i.vDomBottomPad = i.vDomBottom == i.displayRowsCount - 1 ? 0 : Math.max(i.vDomScrollHeight - i.vDomTopPad - r - l, 0)))
          : ((this.vDomTopPad = 0),
          ...
          i.table.options.groupBy &&
            ...
            (i.tableElement.style.minWidth = i.table.columnManager.getWidth());
    ...
    (s.prototype.scrollVertical = function (e) {
      ...
      if (-t > i || o > i) {
        ...
        e
          ? (t < 0 && this._addTopRow(-t), o < 0 && (this.vDomScrollHeight - this.scrollTop > this.vDomWindowBuffer ? this._removeBottomRow(-o) : (this.vDomScrollPosBottom = this.scrollTop)))
          : (t >= 0 && (this.scrollTop > this.vDomWindowBuffer ? this._removeTopRow(t) : (this.vDomScrollPosTop = this.scrollTop)), o >= 0 && this._addBottomRow(o));
    }),
    (s.prototype._addTopRow = function (e) {
      ...
      if (this.vDomTop) {
        ...
        e >= a &&
          ...
          (s.initialized && s.heightInitialized) || (this.vDomTopNewRows.push(s), s.heightInitialized || s.clearCellHeight()),
          s.initialize(),
          (this.vDomTopPad -= a),
    ...
    (s.prototype._addBottomRow = function (e) {
      ...
      if (this.vDomBottom < this.displayRowsCount - 1) {
        ...
        e >= a &&
          ...
          (s.initialized && s.heightInitialized) || (this.vDomBottomNewRows.push(s), s.heightInitialized || s.clearCellHeight()),
          s.initialize(),
          ...
          s.getHeight() > this.vDomWindowBuffer && (this.vDomWindowBuffer = 2 * s.getHeight()),
          t < this.vDomMaxRenderChain && this.vDomBottom < this.displayRowsCount - 1 && e >= (i[this.vDomBottom + 1].getHeight() || this.vDomRowHeight)
    ...
    (s.prototype.adjustTableSize = function () {
      ...
      if ('virtual' === this.renderMode) {
        ...
        this.fixedHeight
          ? ((this.element.style.minHeight = 'calc(100% - ' + o + 'px)'), (this.element.style.height = 'calc(100% - ' + o + 'px)'), (this.element.style.maxHeight = 'calc(100% - ' + o + 'px)'))
    ...
    (s.prototype.restoreRedraw = function () {
      (this.redrawBlock = !1),
        this.redrawBlockRestoreConfig
          ? (this.refreshActiveData(this.redrawBlockRestoreConfig.stage, this.redrawBlockRestoreConfig.skipStage, this.redrawBlockRestoreConfig.renderInPosition), (this.redrawBlockRestoreConfig = !1))
    ...
    (s.prototype.redraw = function (e) {
      ...
      this.adjustTableSize(),
        ...
        e
          ? this.renderTable()
          : ('classic' == this.renderMode ? (this.table.options.groupBy ? this.refreshActiveData('group', !1, !1) : this._simpleRender()) : (this.reRenderInPosition(), this.scrollHorizontal(t)),
  ...
  (r.prototype.createElement = function () {
    ...
    (r.prototype.generateElement = function () {
      ...
      !1 !== i.table.options.selectable && i.table.modExists('selectRow') && i.table.modules.selectRow.initializeRow(this),
        ...
        i.table.options.rowContextMenu && this.table.modExists('menu') && i.table.modules.menu.initializeRow(this),
        ...
        i.table.options.rowDblTap &&
          ...
          i.element.addEventListener('touchend', function (t) {
            e
              ? (clearTimeout(e), (e = null), i.table.options.rowDblTap(t, i.getComponent()))
              : (e = setTimeout(function () {
                  clearTimeout(e), (e = null);
                }, 300));
          })),
    ...
    (r.prototype.initialize = function (e) {
      ...
      if (!t.initialized || e) {
        ...
        this.table.modExists('frozenColumns') && this.table.modules.frozenColumns.layoutRow(this),
          ...
          e && t.normalizeHeight(),
          t.table.options.dataTree && t.table.modExists('dataTree') && t.table.modules.dataTree.layoutRow(this),
          'collapse' === t.table.options.responsiveLayout && t.table.modExists('responsiveLayout') && t.table.modules.responsiveLayout.layoutRow(this),
          t.table.options.rowFormatter && t.table.options.rowFormatter(t.getComponent()),
          t.table.options.resizableRows && t.table.modExists('resizeRows') && t.table.modules.resizeRows.initializeRow(t),
          (t.initialized = !0);
      }
    }),
    ...
    (r.prototype.updateData = function (e) {
      ...
      return new Promise(function (s, a) {
        'string' == typeof e && (e = JSON.parse(e)),
          ...
          o.table.modExists('mutator') ? ((n = Object.assign(n, o.data)), (n = Object.assign(n, e)), (t = o.table.modules.mutator.transformRow(n, 'data', e))) : (t = e);
        ...
        i ? (o.normalizeHeight(!0), o.table.options.rowFormatter && o.table.options.rowFormatter(o.getComponent())) : ((o.initialized = !1), (o.height = 0), (o.heightStyled = '')),
          !1 !== o.table.options.dataTree &&
            o.table.modExists('dataTree') &&
            o.table.modules.dataTree.redrawNeeded(e) &&
            (o.table.modules.dataTree.initializeRow(o), o.table.modules.dataTree.layoutRow(o), o.table.rowManager.refreshActiveData('tree', !1, !0)),
      ...
      return new Promise(function (t, o) {
        ...
        e.table.options.history &&
          ...
          (e.table.options.groupBy && e.table.modExists('groupRows')
            ? ((n = e.getGroup().rows), (i = n.indexOf(e)) && (i = n[i - 1]))
            : (i = e.table.rowManager.getRowIndex(e)) && (i = e.table.rowManager.rows[i - 1]),
          e.table.modules.history.action('rowDelete', e, { data: e.getData(), pos: !i, index: i })),
          e.deleteActual(),
          t();
      });
    }),
  ...
  (c.prototype.build = function () {
    ...
    (c.prototype._configureCell = function () {
      ...
      if (
        ...
        e.column.vertAlign && ((o.style.display = 'inline-flex'), (o.style.alignItems = n[e.column.vertAlign] || ''), e.column.hozAlign && (o.style.justifyContent = s[e.column.hozAlign] || '')),
    ...
    (c.prototype._generateTooltip = function () {
      ...
      e
        ? (!0 === e ? (e = this.value) : 'function' == typeof e && !1 === (e = e(this.getComponent())) && (e = ''), void 0 === e && (e = ''), this.element.setAttribute('title', e))
    ...
    (c.prototype.setValue = function (e, t) {
      ...
      i &&
        (this.table.options.history && this.table.modExists('history') && this.table.modules.history.action('cellEdit', this, { oldValue: this.oldValue, newValue: this.value }),
        (o = this.getComponent()),
    ...
    (c.prototype.setValueProcessData = function (e, t) {
      var o = !1;
      return (
        this.value != e && ((o = !0), t && this.column.modules.mutate && (e = this.table.modules.mutator.transformCell(this, e))),
        this.setValueActual(e),
        o &&
          this.table.modExists('columnCalcs') &&
          (this.column.definition.topCalc || this.column.definition.bottomCalc) &&
          (this.table.options.groupBy && this.table.modExists('groupRows')
            ? (('table' != this.table.options.columnCalcs && 'both' != this.table.options.columnCalcs) || this.table.modules.columnCalcs.recalc(this.table.rowManager.activeRows),
              'table' != this.table.options.columnCalcs && this.table.modules.columnCalcs.recalcRowGroup(this.row))
            : this.table.modules.columnCalcs.recalc(this.table.rowManager.activeRows)),
        o
      );
    }),
    (c.prototype.setValueActual = function (e) {
      (this.oldValue = this.value),
        ...
        this.column.definition.contextMenu && this.table.modExists('menu') && this.table.modules.menu.initializeCell(this),
        ...
        switch (_typeof(this.table.options.footerElement)) {
          case 'string':
            '<' === this.table.options.footerElement[0]
              ...
              : ((this.external = !0), (this.element = document.querySelector(this.table.options.footerElement)));
            break;
          default:
  ...
  (d.prototype.defaultOptions = {
    ...
    (d.prototype.initializeOptions = function (e) {
      ...
      for (var t in this.defaultOptions)
        t in e
          ...
          ? (this.options[t] = [])
          : 'object' === _typeof(this.defaultOptions[t]) && null !== this.defaultOptions[t]
          ? (this.options[t] = {})
    ...
    (d.prototype.initializeElement = function (e) {
      return 'undefined' != typeof HTMLElement && e instanceof HTMLElement
        ? ((this.element = e), !0)
        : 'string' == typeof e
        ? ((this.element = document.querySelector(e)), !!this.element || (console.error('Tabulator Creation Error - no element found matching selector: ', e), !1))
        : (console.error('Tabulator Creation Error - Invalid element provided:', e), !1);
    }),
    (d.prototype._mapDepricatedFunctionality = function () {
      (this.options.persistentLayout || this.options.persistentSort || this.options.persistentFilter) && (this.options.persistence || (this.options.persistence = {})),
        ...
        !0 !== this.options.printVisibleRows &&
          (console.warn('printVisibleRows option is deprecated, you should now use the printRowRange option'), (this.options.persistence.printRowRange = 'active')),
        !0 !== this.options.printCopyStyle &&
          (console.warn('printCopyStyle option is deprecated, you should now use the printStyled option'), (this.options.persistence.printStyled = this.options.printCopyStyle)),
        ...
        this.options.columnVertAlign &&
          (console.warn('columnVertAlign option is deprecated, you should now use the columnHeaderVertAlign option'), (this.options.columnHeaderVertAlign = this.options.columnVertAlign));
    }),
    ...
    (d.prototype._buildElement = function () {
      ...
      i.height && ((i.height = isNaN(i.height) ? i.height : i.height + 'px'), (t.style.height = i.height)),
        !1 !== i.minHeight && ((i.minHeight = isNaN(i.minHeight) ? i.minHeight : i.minHeight + 'px'), (t.style.minHeight = i.minHeight)),
        !1 !== i.maxHeight && ((i.maxHeight = isNaN(i.maxHeight) ? i.maxHeight : i.maxHeight + 'px'), (t.style.maxHeight = i.maxHeight)),
      ...
      if (
        ...
        i.persistence && this.modExists('persistence', !0) && o.persistence.config.columns && (i.columns = o.persistence.load('columns', i.columns)),
        ...
        var r = [];
        i.persistence && this.modExists('persistence', !0) && o.persistence.config.sort
          ? !1 === (r = o.persistence.load('sort')) && i.initialSort && (r = i.initialSort)
          : i.initialSort && (r = i.initialSort),
          o.sort.setSort(r);
      }
      if (((i.persistence && this.modExists('persistence', !0) && o.persistence.config.filter) || i.initialFilter) && this.modExists('filter', !0)) {
        var l = [];
        i.persistence && this.modExists('persistence', !0) && o.persistence.config.filter
          ? !1 === (l = o.persistence.load('filter')) && i.initialFilter && (l = i.initialFilter)
    ...
    (d.prototype._loadInitialData = function () {
      ...
      if (e.options.pagination && e.modExists('page'))
        if ((e.modules.page.reset(!0, !0), 'local' == e.options.pagination)) {
          if (e.options.data.length) e.rowManager.setData(e.options.data, !1, !0);
          else {
        ...
        e.options.data.length
          ...
          : (e.options.ajaxURL || e.options.ajaxURLGenerator) && e.modExists('ajax')
          ? e.modules.ajax
              .loadData(!1, !0)
              .then(function () {})
              .catch(function () {})
    ...
    (d.prototype.destroy = function () {
      var e = this.element;
      for (
        d.prototype.comms.deregister(this),
          ...
          this.modExists('keybindings') && this.modules.keybindings.clearBindings();
        e.firstChild;
    ...
    (d.prototype._setData = function (e, t, o, i, n) {
      ...
      return 'string' != typeof e
        ? e
          ? s.rowManager.setData(e, i, n)
          : s.modExists('ajax') && (s.modules.ajax.getUrl || s.options.ajaxURLGenerator)
          ? 'remote' == s.options.pagination && s.modExists('page', !0)
            ? (s.modules.page.reset(!0, !0), s.modules.page.setPage(1))
            : s.modules.ajax.loadData(i, n)
          : s.rowManager.setData([], i, n)
        : 0 == e.indexOf('{') || 0 == e.indexOf('[')
        ? s.rowManager.setData(JSON.parse(e), i, n)
        : s.modExists('ajax', !0)
        ? (t && s.modules.ajax.setParams(t),
          o && s.modules.ajax.setConfig(o),
          s.modules.ajax.setUrl(e),
          'remote' == s.options.pagination && s.modExists('page', !0) ? (s.modules.page.reset(!0, !0), s.modules.page.setPage(1)) : s.modules.ajax.loadData(i, n))
        : void 0;
    }),
    ...
    (d.prototype.setHeight = function (e) {
      'classic' !== this.rowManager.renderMode
        ? ((this.options.height = isNaN(e) ? e : e + 'px'), (this.element.style.height = this.options.height), this.rowManager.setRenderMode(), this.rowManager.redraw())
    ...
    (d.prototype.selectRow = function (e) {
      this.modExists('selectRow', !0) &&
        (!0 === e && (console.warn("passing a boolean to the selectRowselectRow function is deprecated, you should now pass the string 'active'"), (e = 'active')),
    ...
    (d.prototype.setPageToRow = function (e) {
      var t = this;
      return new Promise(function (o, i) {
        t.options.pagination && t.modExists('page')
    ...
    (d.prototype.moduleBindings = {}),
    (d.prototype.extendModule = function (e, t, o) {
      if (d.prototype.moduleBindings[e]) {
        var i = d.prototype.moduleBindings[e].prototype[t];
        if (i)
          if ('object' == (void 0 === o ? 'undefined' : _typeof(o))) for (var n in o) i[n] = o[n];
    ...
    (d.prototype.comms = {
      ...
      lookupTable: function (e, t) {
        ...
        if ('string' == typeof e) {
          ...
          ('undefined' != typeof HTMLElement && e instanceof HTMLElement) || e instanceof d
            ? (i = d.prototype.comms.matchElement(e)) && n.push(i)
            : Array.isArray(e)
            ? e.forEach(function (e) {
  ...
  (h.prototype.initialize = function (e) {
    this.modes[e] ? (this.mode = e) : (console.warn("Layout Error - invalid mode set, defaulting to 'fitData' : " + e), (this.mode = 'fitData')),
    ...
    (h.prototype.modes = {
      ...
      fitDataStretch: function (e) {
        ...
        e.forEach(function (e, i) {
          ...
          s
            ? ((n = i - o + s.getWidth()),
              this.table.options.responsiveLayout && this.table.modExists('responsiveLayout', !0) && (s.setWidth(0), this.table.modules.responsiveLayout.update()),
              n > 0 ? s.setWidth(n) : s.reinitializeWidth())
            : this.table.options.responsiveLayout && this.table.modExists('responsiveLayout', !0) && this.table.modules.responsiveLayout.update();
      },
      fitColumns: function (e) {
          ...
          return (
            ...
            l.length
              ? (l.forEach(function (e) {
                ...
                (u = i - c),
                (d = p ? Math.floor(u / p) : u),
                (h = u - d * p),
                (h += o(m, u, d, s)))
              : ((h = p ? i - Math.floor(i / p) * p : i),
        ...
        this.table.options.responsiveLayout && this.table.modExists('responsiveLayout', !0) && this.table.modules.responsiveLayout.update(),
          ...
          e.forEach(function (e) {
            var o, i, n;
            e.visible &&
              ((o = e.definition.width),
              (i = parseInt(e.minWidth)),
              o
                ? ((n = t(o)), (s += n > i ? n : i), e.definition.widthShrink && (u.push({ column: e, width: n > i ? n : i }), (d += e.definition.widthShrink)))
                : (c.push({ column: e, width: 0 }), (r += e.definition.widthGrow || 1)));
          }),
          (a = n - s),
          (l = Math.floor(a / r));
        var p = o(c, a, l, !1);
  ...
  (p.prototype.setHeaderFilterPlaceholder = function (e) {
    ...
    (p.prototype.setLocale = function (e) {
      ...
      if (((e = e || 'default'), !0 === e && navigator.language && (e = navigator.language.toLowerCase()), e && !o.langs[e])) {
        var i = e.split('-')[0];
        o.langs[i]
          ? (console.warn('Localization Error - Exact matching locale not found, using closest match: ', e, i), (e = i))
          : (console.warn('Localization Error - Matching locale not found, using default: ', e), (e = 'default'));
      }
      (o.locale = e),
        (o.lang = d.prototype.helpers.deepClone(o.langs.default || {})),
        'default' != e && t(o.langs[e], o.lang),
  ...
  (m.prototype.getConnections = function (e) {
    var t,
      ...
      i = [];
    return (
      (t = d.prototype.comms.lookupTable(e)),
  ...
  (f.prototype.initializeColumn = function (e) {
    ...
    this.allowedTypes.forEach(function (n) {
      ...
      e.definition[a] && (s = t.lookupAccessor(e.definition[a])) && ((o = !0), (i[a] = { accessor: s, params: e.definition[a + 'Params'] || {} }));
    }),
    ...
    (f.prototype.transformRow = function (e, t) {
      ...
      return (
        o.table.columnManager.traverse(function (e) {
          var o, s, a, r;
          e.modules.accessor &&
            (s = e.modules.accessor[i] || e.modules.accessor.accessor || !1) &&
            'undefined' != (o = e.getFieldValue(n)) &&
            ((r = e.getComponent()), (a = 'function' == typeof s.params ? s.params(o, n, t, r) : s.params), e.setFieldValue(n, s.accessor(o, n, t, a, r)));
        }),
        n
      );
    }),
    (f.prototype.accessors = {}),
    d.prototype.registerModule('accessor', f);
  var g = function (e) {
    (this.table = e),
      (this.config = !1),
      (this.url = ''),
  ...
  (g.prototype.initialize = function () {
    ...
    this.loaderElement.appendChild(this.msgElement),
      this.table.options.ajaxLoaderLoading &&
        ('string' == typeof this.table.options.ajaxLoaderLoading
          ? ((e = document.createElement('template')), (e.innerHTML = this.table.options.ajaxLoaderLoading.trim()), (this.loadingElement = e.content.firstChild))
      ...
      this.table.options.ajaxLoaderError &&
        ('string' == typeof this.table.options.ajaxLoaderError
          ? ((e = document.createElement('template')), (e.innerHTML = this.table.options.ajaxLoaderError.trim()), (this.errorElement = e.content.firstChild))
      ...
      this.table.options.ajaxProgressiveLoad &&
        (this.table.options.pagination
          ? ((this.progressiveLoad = !1), console.error('Progressive Load Error - Pagination and progressive load cannot be used at the same time'))
          : this.table.modExists('page')
          ? ((this.progressiveLoad = this.table.options.ajaxProgressiveLoad), this.table.modules.page.initializeProgressive(this.progressiveLoad))
    ...
    (g.prototype.setConfig = function (e) {
      if ((this._loadDefaultConfig(), 'string' == typeof e)) this.config.method = e;
    ...
    (g.prototype.nextPage = function (e) {
      var t;
      this.loading ||
        ((t = this.table.options.ajaxProgressiveLoadScrollMargin || 2 * this.table.rowManager.getElement().clientHeight),
        e < t &&
    ...
    (g.prototype.generateParamsList = function (e, t) {
      ...
      else if ('object' === (void 0 === e ? 'undefined' : _typeof(e))) for (var n in e) i = i.concat(o.generateParamsList(e[n], t ? t + '[' + n + ']' : n));
    ...
    (g.prototype.sendRequest = function (e) {
      ...
      return (
        ...
        new Promise(function (s, a) {
          !1 !== i.table.options.ajaxRequesting.call(o.table, i.url, i.params)
            ? ((i.loading = !0),
              e || i.showLoader(),
              o
                ...
                .then(function (e) {
                  t === i.requestOrder
                    ? (i.table.options.ajaxResponse && (e = i.table.options.ajaxResponse.call(i.table, i.url, i.params, e)), s(e), i.hideLoader(), (i.loading = !1))
    ...
    (g.prototype.defaultConfig = { method: 'GET' }),
      ...
      return new Promise(function (s, a) {
        ...
        e
          ? (void 0 === t.headers && (t.headers = {}),
            ...
            'cors' == t.mode
              ? (void 0 === t.headers['Access-Control-Allow-Origin'] && (t.headers['Access-Control-Allow-Origin'] = window.location.origin),
  ...
  (b.prototype.createElement = function () {
    ...
    (b.prototype.initializeColumn = function (e) {
      var t = e.definition,
        o = { topCalcParams: t.topCalcParams || {}, botCalcParams: t.bottomCalcParams || {} };
      if (t.topCalc) {
    ...
    (b.prototype.removeCalcs = function () {
      var e = !1;
      this.topInitialized && ((this.topInitialized = !1), this.topElement.parentNode.removeChild(this.topElement), (e = !0)),
        this.botInitialized && ((this.botInitialized = !1), this.table.footerManager.remove(this.botElement), (e = !0)),
    ...
    (b.prototype.recalcAll = function () {
      ...
      if (
        ...
        ('group' !== this.table.options.columnCalcs && this.recalc(this.table.rowManager.activeRows), this.table.options.groupBy && 'table' !== this.table.options.columnCalcs)
      ) {
    ...
    (b.prototype.recalcGroup = function (e) {
      ...
      e &&
        e.calcs &&
        (e.calcs.bottom && ((t = this.rowsToData(e.rows)), (o = this.generateRowData('bottom', t)), e.calcs.bottom.updateData(o), e.calcs.bottom.reinitialize()),
        e.calcs.top && ((t = this.rowsToData(e.rows)), (o = this.generateRowData('top', t)), e.calcs.top.updateData(o), e.calcs.top.reinitialize()));
    }),
        ...
        (o.generateCells = function () {
          ...
          i.table.columnManager.columnsByIndex.forEach(function (n) {
            i.genColumn.setField(n.getField()),
              ...
              n.definition[e + 'CalcFormatter'] && i.table.modExists('format')
                ? (i.genColumn.modules.format = { formatter: i.table.modules.format.getFormatter(n.definition[e + 'CalcFormatter']), params: n.definition[e + 'CalcFormatterParams'] })
                : (i.genColumn.modules.format = { formatter: i.table.modules.format.getFormatter('plaintext'), params: {} }),
    ...
    (b.prototype.getResults = function () {
      ...
      return (
        this.table.options.groupBy && this.table.modExists('groupRows')
          ? ((e = this.table.modules.groupRows.getGroups(!0)),
            e.forEach(function (e) {
              o[e.getKey()] = t.getGroupResults(e);
            }))
          : (o = { top: this.topRow ? this.topRow.getData() : {}, bottom: this.botRow ? this.botRow.getData() : {} }),
        o
      );
    }),
    (b.prototype.getGroupResults = function (e) {
      ...
      return (
        ...
        { top: o.calcs.top ? o.calcs.top.getData() : {}, bottom: o.calcs.bottom ? o.calcs.bottom.getData() : {}, groups: n }
      );
    }),
  ...
  (v.prototype.initialize = function () {
    ...
    (this.mode = this.table.options.clipboard),
      ...
      (!0 !== this.mode && 'copy' !== this.mode) ||
        this.table.element.addEventListener('copy', function (t) {
          var o, i, n;
          if (!e.blocked) {
            if ((t.preventDefault(), e.customSelection)) (o = e.customSelection), e.table.options.clipboardCopyFormatter && (o = e.table.options.clipboardCopyFormatter('plain', o));
            else {
              ...
              (i = e.table.modules.export.genereateHTMLTable(n)),
                ...
                e.table.options.clipboardCopyFormatter && ((o = e.table.options.clipboardCopyFormatter('plain', o)), (i = e.table.options.clipboardCopyFormatter('html', i)));
            }
            window.clipboardData && window.clipboardData.setData
              ...
              ? (t.clipboardData.setData('text/plain', o), i && t.clipboardData.setData('text/html', i))
              : t.originalEvent && t.originalEvent.clipboardData.setData && (t.originalEvent.clipboardData.setData('text/plain', o), i && t.originalEvent.clipboardData.setData('text/html', i)),
        ...
        (!0 !== this.mode && 'copy' !== this.mode) ||
          ...
          void 0 !== window.getSelection && void 0 !== document.createRange
            ? ((e = document.createRange()),
              ...
              o.removeAllRanges(),
              o.addRange(e))
            : void 0 !== document.selection && void 0 !== document.body.createTextRange && ((i = document.body.createTextRange()), i.moveToElementText(this.table.element), i.select()),
    ...
    (v.prototype.paste = function (e) {
      ...
      this.checkPaseOrigin(e) &&
        ...
        o
          ? (e.preventDefault(), this.table.modExists('mutator') && (o = this.mutateData(o)), (i = this.pasteAction.call(this, o)), this.table.options.clipboardPasted.call(this.table, t, o, i))
    ...
    (v.prototype.getPasteData = function (e) {
      ...
      return (
        window.clipboardData && window.clipboardData.getData
          ...
          : e.originalEvent && e.originalEvent.clipboardData.getData && (t = e.originalEvent.clipboardData.getData('text/plain')),
        t
      );
    }),
  ...
  (y.prototype.initialize = function () {
    ...
    switch (
      ...
      o.dataTreeBranchElement &&
        (!0 === o.dataTreeBranchElement
          ...
          ? ((e = document.createElement('div')), (e.innerHTML = o.dataTreeBranchElement), (this.branchEl = e.firstChild))
          : (this.branchEl = o.dataTreeBranchElement)),
      o.dataTreeCollapseElement
        ? 'string' == typeof o.dataTreeCollapseElement
          ? ((e = document.createElement('div')), (e.innerHTML = o.dataTreeCollapseElement), (this.collapseEl = e.firstChild))
      ...
      o.dataTreeExpandElement
        ? 'string' == typeof o.dataTreeExpandElement
          ? ((e = document.createElement('div')), (e.innerHTML = o.dataTreeExpandElement), (this.expandEl = e.firstChild))
    ...
    (y.prototype.layoutRow = function (e) {
      ...
      i.branchEl && (i.branchEl.parentNode && i.branchEl.parentNode.removeChild(i.branchEl), (i.branchEl = !1)),
        ...
        e.element.classList.add('tabulator-tree-level-' + i.index),
        i.index &&
          (this.branchEl
            ...
            : (o.style.paddingLeft = parseInt(window.getComputedStyle(o, null).getPropertyValue('padding-left')) + i.index * this.indent + 'px'));
    }),
    ...
    (y.prototype.getChildren = function (e) {
      ...
      return (
        !1 !== o.children &&
          o.open &&
          (Array.isArray(o.children) || (o.children = this.generateChildren(e)),
          (i = this.table.modExists('filter') ? this.table.modules.filter.filter(o.children) : o.children),
          this.table.modExists('sort') && this.table.modules.sort.sort(i),
          i.forEach(function (e) {
            n.push(e),
    ...
    (y.prototype.expandRow = function (e, t) {
      ...
      !1 !== o.children &&
        ((o.open = !0), e.reinitialize(), this.table.rowManager.refreshActiveData('tree', !1, !0), this.table.options.dataTreeRowExpanded(e.getComponent(), e.modules.dataTree.index));
    }),
    (y.prototype.collapseRow = function (e) {
      var t = e.modules.dataTree;
      !1 !== t.children &&
        ((t.open = !1), e.reinitialize(), this.table.rowManager.refreshActiveData('tree', !1, !0), this.table.options.dataTreeRowCollapsed(e.getComponent(), e.modules.dataTree.index));
    }),
    ...
    (y.prototype.getFilteredTreeChildren = function (e) {
      ...
      return (
        o.children &&
          (Array.isArray(o.children) || (o.children = this.generateChildren(e)),
          (t = this.table.modExists('filter') ? this.table.modules.filter.filter(o.children) : o.children),
          t.forEach(function (e) {
    ...
    (y.prototype.rowDelete = function (e) {
      ...
      o && ((t = this.findChildIndex(e, o)), !1 !== t && o.data[this.field].splice(t, 1), o.data[this.field].length || delete o.data[this.field], this.initializeRow(o), this.layoutRow(o)),
        this.table.rowManager.refreshActiveData('tree', !1, !0);
    }),
    (y.prototype.addTreeChildRow = function (e, t, o, i) {
      var n = !1;
      'string' == typeof t && (t = JSON.parse(t)),
        Array.isArray(e.data[this.field]) || ((e.data[this.field] = []), (e.modules.dataTree.open = this.startOpen(e.getComponent(), e.modules.dataTree.index))),
  ...
  (w.prototype.download = function (e, t, o, i, n) {
    ...
    (w.prototype.triggerDownload = function (e, t, o, i, n) {
      ...
      (a = this.table.options.downloadReady.call(this.table, e, a)) &&
        (n
          ...
          : (s.setAttribute('href', window.URL.createObjectURL(a)), s.setAttribute('download', i), (s.style.display = 'none'), document.body.appendChild(s), s.click(), document.body.removeChild(s)),
    ...
    (w.prototype.downloaders = {
      ...
      xlsx: function (e, t, o) {
        function i() {
          ...
          return (
            e.forEach(function (e, i) {
              ...
              e.columns.forEach(function (e, t) {
                e
                  ? (n.push(e.value instanceof Date || 'object' !== _typeof(e.value) ? e.value : JSON.stringify(e.value)),
                    (e.width > 1 || e.height > -1) && o.push({ s: { r: i, c: t }, e: { r: i + e.height - 1, c: t + e.width - 1 } }))
                  : n.push('');
              }),
                t.push(n);
            }),
        ...
        var n,
          s = this,
          a = t.sheetName || 'Sheet1',
          r = XLSX.utils.book_new();
        if (((r.SheetNames = []), (r.Sheets = {}), t.sheetOnly)) return void o(i());
        if (t.sheets)
          for (var l in t.sheets)
            !0 === t.sheets[l]
              ? (r.SheetNames.push(l), (r.Sheets[l] = i()))
              : (r.SheetNames.push(l),
                this.table.modules.comms.send(t.sheets[l], 'download', 'intercept', {
                  type: 'xlsx',
                  options: { sheetOnly: !0 },
                  active: s.active,
        ...
        t.documentProcessing && (r = t.documentProcessing(r)),
          (n = XLSX.write(r, { bookType: 'xlsx', bookSST: !0, type: 'binary' })),
          o(
            (function (e) {
  ...
  (E.prototype.initializeColumn = function (e) {
    ...
    switch (_typeof(e.definition.editor)) {
      case 'string':
        'tick' === e.definition.editor && ((e.definition.editor = 'tickCross'), console.warn('DEPRECATION WARNING - the tick editor has been deprecated, please use the tickCross editor')),
        ...
        !0 === e.definition.editor &&
          ('function' != typeof e.definition.formatter
            ? ('tick' === e.definition.formatter &&
                ((e.definition.formatter = 'tickCross'), console.warn('DEPRECATION WARNING - the tick editor has been deprecated, please use the tickCross editor')),
              t.editors[e.definition.formatter] ? (o.editor = t.editors[e.definition.formatter]) : (o.editor = t.editors.input))
            : console.warn('Editor Error - Cannot auto lookup editor for a custom formatter: ', e.definition.formatter));
    }
    ...
    (E.prototype.focusScrollAdjust = function (e) {
      if ('virtual' == this.table.rowManager.getRenderMode()) {
        ...
        i.offsetTop < t
          ...
          : i.offsetTop + i.offsetHeight > o && (this.table.rowManager.element.scrollTop += i.offsetTop + i.offsetHeight - o);
        var n = this.table.rowManager.element.scrollLeft,
          ...
          a = e.getElement();
        a.offsetLeft;
        this.table.modExists('frozenColumns') && ((n += parseInt(this.table.modules.frozenColumns.leftMargin)), (s -= parseInt(this.table.modules.frozenColumns.rightMargin))),
          a.offsetLeft < n
            ? (this.table.rowManager.element.scrollLeft -= n - a.offsetLeft)
            : a.offsetLeft + a.offsetWidth > s && (this.table.rowManager.element.scrollLeft += a.offsetLeft + a.offsetWidth - s);
      }
    }),
    (E.prototype.edit = function (e, t, o) {
      function i(t) {
        if (c.currentCell === e) {
          var o = !0;
          return (
            e.column.modules.validate && c.table.modExists('validate') && 'manual' != c.table.options.validationMode && (o = c.table.modules.validate.validate(e.column.modules.validate, e, t)),
            !0 === o || 'highlight' === c.table.options.validationMode
              ? (c.clearEditor(),
                e.setValue(t, !0),
                ...
                !0 === o || (h.classList.add('tabulator-validation-fail'), c.table.options.validationFailed.call(c.table, e.getComponent(), t, o), !1))
              : ((c.invalidEdit = !0), h.classList.add('tabulator-validation-fail'), c.focusCellNoEvent(e, !0), d(), c.table.options.validationFailed.call(c.table, e.getComponent(), t, o), !1)
          );
        }
      }
      function n() {
      ...
      if (u || o) {
        if (
          ...
          (r = e.getComponent()),
          this.mouseClick && ((this.mouseClick = !1), e.column.cellEvents.cellClick && e.column.cellEvents.cellClick.call(this.table, t, r)),
    ...
    (E.prototype.editors = {
      input: function (e, t, o, i, n) {
        ...
        if (
          (r.setAttribute('type', n.search ? 'search' : 'text'),
          (r.style.padding = '4px'),
          (r.style.width = '100%'),
          (r.style.boxSizing = 'border-box'),
          n.elementAttributes && 'object' == _typeof(n.elementAttributes))
        )
          for (var l in n.elementAttributes) '+' == l.charAt(0) ? ((l = l.slice(1)), r.setAttribute(l, r.getAttribute(l) + n.elementAttributes['+' + l])) : r.setAttribute(l, n.elementAttributes[l]);
        return (
          (r.value = void 0 !== a ? a : ''),
          t(function () {
      ...
      textarea: function (e, t, o, i, n) {
        function s(t) {
          ((null === a || void 0 === a) && '' !== c.value) || c.value !== a
            ? (o(c.value) && (a = c.value),
              setTimeout(function () {
        ...
        if (
          ...
          for (var d in n.elementAttributes) '+' == d.charAt(0) ? ((d = d.slice(1)), c.setAttribute(d, c.getAttribute(d) + n.elementAttributes['+' + d])) : c.setAttribute(d, n.elementAttributes[d]);
        return (
          (c.value = l),
          t(function () {
      ...
      number: function (e, t, o, i, n) {
        ...
        if (
          ...
          for (var c in n.elementAttributes) '+' == c.charAt(0) ? ((c = c.slice(1)), l.setAttribute(c, l.getAttribute(c) + n.elementAttributes['+' + c])) : l.setAttribute(c, n.elementAttributes[c]);
        l.value = a;
        var u = function (e) {
          s();
        };
      ...
      select: function (e, t, o, i, n) {
        function s(t) {
          var o,
            ...
            s = C.table.getData();
          return (
            (o = t ? C.table.columnManager.getColumnByField(t) : e.getColumn()._getSelf()),
            o
              ? (s.forEach(function (e) {
                  var t = o.getFieldValue(e);
                  null !== t && void 0 !== t && '' !== t && (i[t] = !0);
                }),
                (i = n.sortValuesList ? ('asc' == n.sortValuesList ? Object.keys(i).sort() : Object.keys(i).sort().reverse()) : Object.keys(i)))
        ...
        function a(t, o) {
          function i(e) {
            var e = { label: e.label, value: e.value, itemParams: e.itemParams, elementAttributes: e.elementAttributes, element: !1 };
          ...
          if (('function' == typeof t && (t = t(e)), Array.isArray(t)))
            t.forEach(function (e) {
              ...
              'object' === (void 0 === e ? 'undefined' : _typeof(e))
                ? e.options
                  ? ((t = { label: e.label, group: !0, itemParams: e.itemParams, elementAttributes: e.elementAttributes, element: !1 }),
                    s.push(t),
                    e.options.forEach(function (e) {
                      i(e);
                    }))
                  : i(e)
                : ((t = { label: e, value: e, element: !1 }), o.indexOf(t.value) > -1 && c(t), n.push(t), s.push(t));
            });
          else
            for (var a in t) {
          ...
          H.forEach(function (t) {
            ...
            if (!o) {
              if (
                ...
                t.group
                  ? (o.classList.add('tabulator-edit-select-list-group'), (o.tabIndex = 0), (o.innerHTML = '' === t.label ? '&nbsp;' : t.label))
                ...
                for (var i in t.elementAttributes)
                  '+' == i.charAt(0) ? ((i = i.slice(1)), o.setAttribute(i, T.getAttribute(i) + t.elementAttributes['+' + i])) : o.setAttribute(i, t.elementAttributes[i]);
        ...
        function l(e, t) {
          !k && z && z.element && z.element.classList.remove('active'),
            z && z.element && z.element.classList.remove('focused'),
            (z = e),
            e.element && (e.element.classList.add('focused'), t && e.element.classList.add('active'));
        }
        function c(e) {
        ...
        function v() {
          if (((A = []), !D.parentNode)) {
            ...
            (D.style.minWidth = x.offsetWidth + 'px'),
              (D.style.top = e.top + x.offsetHeight + 'px'),
        ...
        var E = this,
          ...
          _ = !1;
        if (
          ((Array.isArray(n) || (!Array.isArray(n) && 'object' === (void 0 === n ? 'undefined' : _typeof(n)) && !n.values)) &&
          ...
          for (var F in n.elementAttributes) '+' == F.charAt(0) ? ((F = F.slice(1)), T.setAttribute(F, T.getAttribute(F) + n.elementAttributes['+' + F])) : T.setAttribute(F, n.elementAttributes[F]);
        return (
          (T.value = void 0 !== R || null === R ? R : ''),
          ...
          T.addEventListener('keydown', function (e) {
            ...
            switch (e.keyCode) {
              ...
              case 40:
                (t = S.indexOf(z)),
                  ('editor' == M || ('hybrid' == M && t < S.length - 1)) &&
                    (e.stopImmediatePropagation(), e.stopPropagation(), e.preventDefault(), t < S.length - 1 && (-1 == t ? l(S[0], !k) : l(S[t + 1], !k)));
                break;
              case 37:
              case 39:
          ...
          (D = document.createElement('div')),
          D.classList.add('tabulator-edit-select-list'),
          t(function () {
      ...
      autocomplete: function (e, t, o, i, n) {
        ...
        function a(t) {
          var o,
            ...
            s = E.table.getData();
          return (
            (o = t ? E.table.columnManager.getColumnByField(t) : e.getColumn()._getSelf()),
            o
              ? (s.forEach(function (e) {
                  var t = o.getFieldValue(e);
                  null !== t && void 0 !== t && '' !== t && (i[t] = !0);
                ...
                (i = n.sortValuesList ? ('asc' == n.sortValuesList ? Object.keys(i).sort() : Object.keys(i).sort().reverse()) : Object.keys(i)))
              : console.warn('unable to find matching column to create autocomplete lookup list:', t),
            i
          );
        }
        function r(e, t) {
            ...
            n.searchFunc
              ? ((s = n.searchFunc(e, o)),
                s instanceof Promise
                  ? (l(void 0 !== n.searchingPlaceholder ? n.searchingPlaceholder : 'Searching...'),
                    s
                      .then(function (e) {
                        h(c(e), t);
                      })
              ...
              : ((i = c(o)),
                '' === e
                  ? n.showListOnEmpty && (s = i)
                  : i.forEach(function (t) {
                      (null === t.value && void 0 === t.value) ||
                        ((String(t.value).toLowerCase().indexOf(String(e).toLowerCase()) > -1 || String(t.title).toLowerCase().indexOf(String(e).toLowerCase()) > -1) && s.push(t));
                    }),
                h(s, t));
        }
        function l(e) {
        ...
        function c(e) {
          ...
          if (Array.isArray(e))
            e.forEach(function (e) {
              var o = {};
              'object' === (void 0 === e ? 'undefined' : _typeof(e))
                ? ((o.title = n.listItemFormatter ? n.listItemFormatter(e.value, e.label) : e.label), (o.value = e.value))
                : ((o.title = n.listItemFormatter ? n.listItemFormatter(e, e) : e), (o.value = e)),
                t.push(o);
            });
          else
            for (var o in e) {
          ...
          u(),
            ...
            D.forEach(function (e) {
              ...
              i ||
                ...
                (e.element = i),
                t && e.value == x && ((L.value = e.title), e.element.classList.add('active'), (o = !0)),
                e === k && (e.element.classList.add('active'), (o = !0))),
                T.appendChild(i);
            }),
            o || g(!1);
        }
        function m() {
          b(),
            k
              ? x !== k.value
                ? ((x = k.value), (L.value = k.title), o(k.value))
                : i()
              : n.freetext
              ? ((x = L.value), o(L.value))
              : n.allowEmpty && '' === L.value
              ? ((x = L.value), o(L.value))
              : i();
        }
        function f() {
        ...
        var w = this,
          ...
          z = !1;
        if (
          (L.setAttribute('type', 'search'), (L.style.padding = '4px'), (L.style.width = '100%'), (L.style.boxSizing = 'border-box'), n.elementAttributes && 'object' == _typeof(n.elementAttributes))
        )
          for (var H in n.elementAttributes) '+' == H.charAt(0) ? ((H = H.slice(1)), L.setAttribute(H, L.getAttribute(H) + n.elementAttributes['+' + H])) : L.setAttribute(H, n.elementAttributes[H]);
        return (
          T.classList.add('tabulator-edit-select-list'),
          ...
          L.addEventListener('keydown', function (e) {
            ...
            switch (e.keyCode) {
              ...
              case 40:
                (t = D.indexOf(k)),
                  ('editor' == R || ('hybrid' == R && t < D.length - 1)) && (e.stopImmediatePropagation(), e.stopPropagation(), e.preventDefault(), t < D.length - 1 && g(-1 == t ? D[0] : D[t + 1]));
                break;
              case 37:
              case 39:
      ...
      star: function (e, t, o, i, n) {
        function s(e) {
          h.forEach(function (t, o) {
            o < e
              ? ('ie' == r.table.browser ? t.setAttribute('class', 'tabulator-star-active') : t.classList.replace('tabulator-star-inactive', 'tabulator-star-active'),
                (t.innerHTML =
              ...
              : ('ie' == r.table.browser ? t.setAttribute('class', 'tabulator-star-inactive') : t.classList.replace('tabulator-star-active', 'tabulator-star-inactive'),
                (t.innerHTML =
        ...
        if (
          ...
          for (var f in n.elementAttributes) '+' == f.charAt(0) ? ((f = f.slice(1)), p.setAttribute(f, p.getAttribute(f) + n.elementAttributes['+' + f])) : p.setAttribute(f, n.elementAttributes[f]);
        for (var g = 1; g <= u; g++)
          !(function (e) {
      ...
      progress: function (e, t, o, i, n) {
        ...
        if (
          ...
          for (var f in n.elementAttributes) '+' == f.charAt(0) ? ((f = f.slice(1)), m.setAttribute(f, m.getAttribute(f) + n.elementAttributes['+' + f])) : m.setAttribute(f, n.elementAttributes[f]);
        return (
      ...
      tickCross: function (e, t, o, i, n) {
        ...
        var a = e.getValue(),
          ...
          u = !1;
        if ((r.setAttribute('type', 'checkbox'), (r.style.marginTop = '5px'), (r.style.boxSizing = 'border-box'), n.elementAttributes && 'object' == _typeof(n.elementAttributes)))
          for (var d in n.elementAttributes) '+' == d.charAt(0) ? ((d = d.slice(1)), r.setAttribute(d, r.getAttribute(d) + n.elementAttributes['+' + d])) : r.setAttribute(d, n.elementAttributes[d]);
        return (
          (r.value = a),
          !l || (void 0 !== a && a !== c && '' !== a) || ((u = !0), (r.indeterminate = !0)),
  ...
  (R.prototype.generateExportList = function (e, t, o, i) {
    ...
    (R.prototype.generateColumnGroupHeaders = function () {
      var e = this,
        t = [];
      return (
        (!1 !== this.config.columnGroups ? this.table.columnManager.columns : this.table.columnManager.columnsByIndex).forEach(function (o) {
    ...
    (R.prototype.headersToExportRows = function (e) {
      function t(e, n) {
        ...
        if ((void 0 === o[n] && (o[n] = []), (e.height = e.subGroups ? 1 : s - e.depth + 1), o[n].push(e), e.height > 1))
          for (var a = 1; a < e.height; a++) void 0 === o[n + a] && (o[n + a] = []), o[n + a].push(!1);
    ...
    (R.prototype.bodyToExportRows = function (e) {
      ...
      return (
        ...
        !1 !== this.config.columnCalcs &&
          this.table.modExists('columnCalcs') &&
          (this.table.modules.columnCalcs.topInitialized && e.unshift(this.table.modules.columnCalcs.topRow),
    ...
    (R.prototype.genereateTableElement = function (e) {
      var t = this,
        ...
        r = {};
      return (
        (r.rowFormatter = null !== a ? a : this.table.options.rowFormatter),
        ...
        this.mapElementStyles(this.table.columnManager.getHeadersElement(), i, [
          'border-top',
          'border-left',
          'border-right',
          'border-bottom',
        ...
        e.forEach(function (e, o) {
          switch (e.type) {
            ...
            case 'row':
              ...
              t.mapElementStyles(o % 2 && s.evenRow ? s.evenRow : s.oddRow, a, [
                'border-top',
                'border-left',
                'border-right',
                'border-bottom',
    ...
    (R.prototype.lookupTableStyles = function () {
      ...
      return (
        this.cloneTableStyle &&
          ...
          e.firstRow && ((e.styleCells = e.firstRow.getElementsByClassName('tabulator-cell')), (e.firstCell = e.styleCells[0]), (e.lastCell = e.styleCells[e.styleCells.length - 1]))),
        e
      );
    }),
          ...
          if (e) {
            ...
            (t.colSpan = e.width),
              ...
              e.component._column.visible
                ...
                : e.component._column.definition.width && (t.style.width = e.component._column.definition.width + 'px'),
    ...
    (R.prototype.genereateGroupElement = function (e, t, o) {
      ...
      return (
        ...
        t.groupHeader && t.groupHeader[e.indent]
          ? (s.value = t.groupHeader[e.indent](s.value, e.component._group.getRowCount(), e.component._group.getData(), e.component))
          : !1 === t.groupHeader
          ? (s.value = s.value)
          : (s.value = e.component._group.generator(s.value, e.component._group.getRowCount(), e.component._group.getData(), e.component)),
        (n.colSpan = s.width),
        (n.innerHTML = s.value),
        i.classList.add('tabulator-print-table-group'),
        i.classList.add('tabulator-group-level-' + e.indent),
        s.component.getVisibility() && i.classList.add('tabulator-group-visible'),
      ...
      return (
        ...
        e.columns.forEach(function (a) {
          if (a) {
            ...
            if (
              ((l.definition.cssClass ? l.definition.cssClass.split(' ') : []).forEach(function (e) {
                r.classList.add(e);
              }),
            ...
            if (
              ...
              o.firstCell &&
                (n.mapElementStyles(o.firstCell, r, [
                  'padding-top',
                  'padding-left',
                  'padding-right',
                  'padding-bottom',
              ...
              n.table.options.dataTree &&
                !1 !== n.config.dataTree &&
                ((t.treeElementField && t.treeElementField == l.field) || (!t.treeElementField && 0 == i)) &&
                (e.component._row.modules.dataTree.controlEl && r.insertBefore(e.component._row.modules.dataTree.controlEl.cloneNode(!0), r.firstChild),
              ...
              t.rowFormatter && !1 !== n.config.formatCells)
            ) {
  ...
  (M.prototype.initializeColumn = function (e, t) {
    function o(t) {
      ...
      if (void 0 === e.modules.filter.prevSuccess || e.modules.filter.prevSuccess !== t) {
        if (((e.modules.filter.prevSuccess = t), e.modules.filter.emptyFunc(t))) delete n.headerFilters[s];
        else {
          switch (((e.modules.filter.value = t), _typeof(e.definition.headerFilterFunc))) {
            case 'string':
              n.filters[e.definition.headerFilterFunc]
    ...
    (M.prototype.generateHeaderFilterElement = function (e, t, o) {
      ...
      if ((e.modules.filter.headerElement && e.modules.filter.headerElement.parentNode && e.contentElement.removeChild(e.modules.filter.headerElement.parentNode), m)) {
        switch (
          ...
          case 'string':
            h.table.modules.edit.editors[e.definition.headerFilter]
              ? ((s = h.table.modules.edit.editors[e.definition.headerFilter]),
          ...
          case 'boolean':
            e.modules.edit && e.modules.edit.editor
              ? (s = e.modules.edit.editor)
              : e.definition.formatter && h.table.modules.edit.editors[e.definition.formatter]
              ? ((s = h.table.modules.edit.editors[e.definition.formatter]),
        ...
        if (s) {
          ...
          m
            ? h.table.modules.localize.bind('headerFilters|columns|' + e.definition.field, function (e) {
    ...
    (M.prototype.setHeaderFilterValue = function (e, t) {
      e &&
        (e.modules.filter && e.modules.filter.headerElement
          ? (this.generateHeaderFilterElement(e, t, !0), e.modules.filter.success(t))
          : console.warn('Column Filter Error - No header filter set on column:', e.getField()));
    }),
    ...
    (M.prototype.addFilter = function (e, t, o, i) {
      var n = this;
      Array.isArray(e) || (e = [{ field: e, type: t, value: o, params: i }]),
        e.forEach(function (e) {
    ...
    (M.prototype.findFilter = function (e) {
      ...
      return (
        'function' == typeof e.field
          ...
          : o.filters[e.type]
          ? ((t = o.table.columnManager.getColumnByField(e.field)),
            (i = t
              ? function (i) {
    ...
    (M.prototype.filtersToArray = function (e, t) {
      ...
      return (
        e.forEach(function (e) {
          var n;
          Array.isArray(e) ? i.push(o.filtersToArray(e, t)) : ((n = { field: e.field, type: e.type, value: e.value }), t && 'function' == typeof n.type && (n.type = 'function'), i.push(n));
        }),
        i
      );
    }),
    ...
    (M.prototype.filter = function (e, t) {
      var o = this,
        ...
        n = [];
      return (
        o.table.options.dataFiltering && o.table.options.dataFiltering.call(o.table, o.getFilters()),
        o.table.options.ajaxFiltering || (!o.filterList.length && !Object.keys(o.headerFilters).length)
          ? (i = e.slice(0))
          : e.forEach(function (e) {
  ...
  (L.prototype.initializeColumn = function (e) {
      ...
      switch (void 0 === i ? 'undefined' : _typeof(i)) {
        case 'string':
          'tick' === i &&
            ...
            this.formatters[i] ? (o.formatter = this.formatters[i]) : (console.warn('Formatter Error - No such formatter found: ', i), (o.formatter = this.formatters.plaintext));
          break;
        case 'function':
          o.formatter = i;
          break;
    ...
    (L.prototype.formatters = {
      ...
      link: function (e, t, o) {
        ...
        if ((t.labelField && ((i = e.getData()), (r = i[t.labelField])), t.label))
        ...
        if (r) {
          ...
          return (
            l.setAttribute('href', s + n),
            t.target && l.setAttribute('target', t.target),
            t.download && ((a = 'function' == typeof a ? a(e) : !0 === a ? '' : a), l.setAttribute('download', a)),
      ...
      tickCross: function (e, t, o) {
        ...
        return (a && i) || !0 === i || 'true' === i || 'True' === i || 1 === i || '1' === i
          ? (n.setAttribute('aria-checked', !0), r || '')
          : !s || ('null' !== i && '' !== i && null !== i && void 0 !== i)
      ...
      responsiveCollapse: function (e, t, o) {
        ...
        return (
          n.classList.add('tabulator-responsive-collapse-toggle'),
        ...
        if (((o.type = 'checkbox'), this.table.modExists('selectRow', !0)))
          if (
            ...
            o.addEventListener('change', function (e) {
              ...
              (o.checked = i.isSelected()),
              this.table.modules.selectRow.registerRowSelectCheckbox(i, o);
          } else
            o.addEventListener('change', function (e) {
  ...
  (T.prototype.reset = function () {
    ...
    (T.prototype.initializeColumn = function (e) {
      ...
      e.isGroup ||
        (this.frozenCheck(e)
          ? ((t.position = this.initializationMode), 'left' == this.initializationMode ? this.leftColumns.push(e) : this.rightColumns.unshift(e), (this.active = !0), (e.modules.frozen = t))
          : (this.initializationMode = 'right'));
    }),
    (T.prototype.frozenCheck = function (e) {
      return (
        e.parent.isGroup && e.definition.frozen && console.warn('Frozen Column Error - Parent column group must be frozen, not individual columns or sub column groups'),
    ...
    (T.prototype.layoutColumnPosition = function (e) {
      ...
      this.leftColumns.forEach(function (i, n) {
        if (
          ((i.modules.frozen.margin = t._calcSpace(t.leftColumns, n) + t.table.columnManager.scrollLeft + 'px'),
  ...
  (D.prototype.initialize = function () {
    ...
    (D.prototype.unfreezeRow = function (e) {
      this.rows.indexOf(e);
      e.modules.frozen
        ? ((e.modules.frozen = !1), this.detachRow(e), this.table.rowManager.adjustTableSize(), this.table.rowManager.refreshActiveData('display'), this.rows.length && this.styleRows())
  ...
  (S.prototype.wipe = function () {
    ...
    (S.prototype.addBindings = function () {
      var e,
        ...
        i,
        n = this;
      n.groupManager.table.options.groupClick &&
        ...
        n.groupManager.table.options.groupDblClick &&
        ...
        n.groupManager.table.options.groupContext &&
          n.element.addEventListener('contextmenu', function (e) {
            n.groupManager.table.options.groupContext.call(n.groupManager.table, e, n.getComponent());
          }),
        n.groupManager.table.options.groupContextMenu && n.groupManager.table.modExists('menu') && n.groupManager.table.modules.menu.initializeGroup.call(n.groupManager.table.modules.menu, n),
        n.groupManager.table.options.groupTap &&
          ((o = !1),
        ...
        n.groupManager.table.options.groupDblTap &&
          ((e = null),
          n.element.addEventListener('touchend', function (t) {
            e
              ? (clearTimeout(e), (e = null), n.groupManager.table.options.groupDblTap(t, n.getComponent()))
              : (e = setTimeout(function () {
                  clearTimeout(e), (e = null);
                }, 300));
          })),
        ...
        n.groupManager.table.options.groupToggleElement &&
          ((i = 'arrow' == n.groupManager.table.options.groupToggleElement ? n.arrowElement : n.element),
    ...
    (S.prototype._createGroup = function (e, t) {
      var o = t + '_' + e,
        i = new S(
          ...
          this.groupManager.headerGenerator[t] || this.groupManager.headerGenerator[0],
    ...
    (S.prototype.conformRowData = function (e) {
      return (
        this.field ? (e[this.field] = this.key) : console.warn('Data Conforming Error - Cannot conform row data to match new group as groupBy is a function'),
          ...
          : this.groupList.length ||
            ...
            (this.groupManager.table.modExists('columnCalcs') &&
              (!e &&
                this.groupManager.table.modules.columnCalcs.hasTopCalcs() &&
                (this.calcs.top && (this.calcs.top.detachElement(), this.calcs.top.deleteCells()),
                this.groupManager.table.options.groupClosedShowCalcs && ((this.calcs.top = this.groupManager.table.modules.columnCalcs.generateTopRow(this.rows)), t.push(this.calcs.top))),
              !e &&
                this.groupManager.table.modules.columnCalcs.hasBottomCalcs() &&
                (this.calcs.bottom && (this.calcs.bottom.detachElement(), this.calcs.bottom.deleteCells()),
                this.groupManager.table.options.groupClosedShowCalcs && ((this.calcs.bottom = this.groupManager.table.modules.columnCalcs.generateBottomRow(this.rows)), t.push(this.calcs.bottom))))),
        t
      );
    }),
    (S.prototype.getData = function (e, t) {
    ...
    (S.prototype.show = function () {
      var e = this;
      if (((e.visible = !0), 'classic' != this.groupManager.table.rowManager.getRenderMode() || this.groupManager.table.options.pagination)) this.groupManager.updateGroupRows(!0);
      else {
    ...
    Array.isArray(t) || (t = [t]),
      t.forEach(function (t, o) {
        ...
        'function' == typeof t
          ...
          e.groupIDLookups.push({ field: 'function' != typeof t && t, func: i, values: !!e.allowedValues && e.allowedValues[o] });
      }),
      o &&
        (Array.isArray(o) || (o = [o]),
        o.forEach(function (e) {
  ...
  (H.prototype.clear = function () {
    ...
    (H.prototype.action = function (e, t, o) {
      (this.history = this.history.slice(0, this.index + 1)), this.history.push({ type: e, component: t, data: o }), this.index++;
    }),
    ...
    (H.prototype._rebindRow = function (e, t) {
      this.history.forEach(function (o) {
        if (o.component instanceof r) o.component === e && (o.component = t);
    ...
    (A.prototype._extractOptions = function (e, t, o) {
      ...
      for (var a in i) {
        ...
        l &&
          ...
          l.name &&
          0 === l.name.indexOf('tabulator-') &&
          ((r = l.name.replace('tabulator-', '')), void 0 !== s[r] && (t[s[r]] = this._attribValue(l.value)));
      }
    }),
    ...
    (A.prototype._extractHeaders = function (e, t) {
      for (var o = 0; o < e.length; o++) {
        var i,
          s = e[o],
          a = !1,
          r = this._findCol(s.textContent);
        r ? (a = !0) : (r = { title: s.textContent.trim() }),
  ...
  (P.prototype.initialize = function () {
    ...
    (P.prototype.mapBinding = function (e, t) {
      var o = this,
        i = { action: this.actions[e], keys: [], ctrl: !1, shift: !1, meta: !1 };
      t.toString()
        .toLowerCase()
        .split(' ')
        .join('')
    ...
    (P.prototype.actions = {
      ...
      undo: function (e) {
        this.table.options.history &&
          this.table.modExists('history') &&
          this.table.modExists('edit') &&
          (this.table.modules.edit.currentCell || (e.preventDefault(), this.table.modules.history.undo()));
      },
      redo: function (e) {
        this.table.options.history &&
          this.table.modExists('history') &&
          this.table.modExists('edit') &&
          (this.table.modules.edit.currentCell || (e.preventDefault(), this.table.modules.history.redo()));
      },
  ...
  (_.prototype.initializeColumnHeader = function (e) {
    ...
    e.definition.headerContextMenu &&
      e.getElement().addEventListener('contextmenu', function (t) {
    ...
    (_.prototype.loadMenu = function (e, t, o) {
      ...
      if ((e.preventDefault(), o && o.length)) {
        ...
        this.hideMenu(),
          ...
          o.forEach(function (e) {
            ...
            e.separator
              ...
              : (o.classList.add('tabulator-menu-item'),
                'function' == typeof n && (n = n(t.getComponent())),
                n instanceof Node ? o.appendChild(n) : (o.innerHTML = n),
                'function' == typeof s && (s = s(t.getComponent())),
                s
          ...
          e.pageX + this.menuEl.offsetWidth >= document.body.offsetWidth && ((this.menuEl.style.left = ''), (this.menuEl.style.right = document.body.offsetWidth - e.pageX + 'px')),
    ...
    (_.prototype.hideMenu = function () {
      this.menuEl.parentNode && this.menuEl.parentNode.removeChild(this.menuEl),
        this.escEvent && document.body.removeEventListener('keydown', this.escEvent),
        this.blurEvent &&
    ...
    (_.prototype.menus = {}),
    d.prototype.registerModule('menu', _);
  var F = function (e) {
    (this.table = e),
  ...
  (F.prototype.createPlaceholderElement = function () {
      ...
      e.modules.frozen ||
        ...
        (i.mousemove = function (i) {
          e.parent === o.moving.parent &&
            ((o.touchMove ? i.touches[0].pageX : i.pageX) - d.prototype.helpers.elOffset(t).left + o.table.columnManager.element.scrollLeft > e.getWidth() / 2
              ? (o.toCol === e && o.toColAfter) || (t.parentNode.insertBefore(o.placeholderElement, t.nextSibling), o.moveColumn(e, !0))
              : (o.toCol !== e || o.toColAfter) && (t.parentNode.insertBefore(o.placeholderElement, t), o.moveColumn(e, !1)));
        }.bind(o)),
        ...
        c.addEventListener(
          ...
          function (c) {
            ...
            l.moving &&
              ...
              d > 0
                ? o && d - a > n && (h = o) !== e && ((u = c.touches[0].pageX), h.getElement().parentNode.insertBefore(l.placeholderElement, h.getElement().nextSibling), l.moveColumn(h, !0))
                : i && -d - r > s && (h = i) !== e && ((u = c.touches[0].pageX), h.getElement().parentNode.insertBefore(l.placeholderElement, h.getElement()), l.moveColumn(h, !1)),
              h && ((t = h), (o = h.nextColumn()), (a = n), (n = o ? o.getWidth() / 2 : 0), (i = h.prevColumn()), (r = s), (s = i ? i.getWidth() / 2 : 0)));
          },
          { passive: !0 }
        ),
    ...
    (F.prototype.startMove = function (e, t) {
      var o = t.getElement();
      (this.moving = t),
        (this.startX = (this.touchMove ? e.touches[0].pageX : e.pageX) - d.prototype.helpers.elOffset(o).left),
  ...
  (N.prototype.createPlaceholderElement = function () {
      ...
      t.addEventListener(
        ...
        t.addEventListener('touchmove', function (t) {
          ...
          c.moving &&
            ...
            d > 0
              ? i && d - r > s && (h = i) !== e && ((u = t.touches[0].pageY), h.getElement().parentNode.insertBefore(c.placeholderElement, h.getElement().nextSibling), c.moveRow(h, !0))
              : n && -d - l > a && (h = n) !== e && ((u = t.touches[0].pageY), h.getElement().parentNode.insertBefore(c.placeholderElement, h.getElement()), c.moveRow(h, !1)),
            h && ((o = h), (i = h.nextRow()), (r = s), (s = i ? i.getHeight() / 2 : 0), (n = h.prevRow()), (l = a), (a = n ? n.getHeight() / 2 : 0)));
        }),
    ...
    (N.prototype.startMove = function (e, t) {
      ...
      this.setStartPosition(e, t),
        ...
        (this.placeholderElement.style.height = t.getHeight() + 'px'),
        this.connection
          ? (this.table.element.classList.add('tabulator-movingrow-sending'), this.connectToTables(t))
          : (o.parentNode.insertBefore(this.placeholderElement, o), o.parentNode.removeChild(o)),
        (this.hoverElement = o.cloneNode(!0)),
        this.hoverElement.classList.add('tabulator-moving'),
        this.connection
    ...
    (N.prototype.setStartPosition = function (e, t) {
      ...
      (o = t.getElement()),
        this.connection
          ? ((i = o.getBoundingClientRect()), (this.startX = i.left - n + window.pageXOffset), (this.startY = i.top - s + window.pageYOffset))
          : (this.startY = s - o.getBoundingClientRect().top);
    }),
    (N.prototype.endMove = function (e) {
      (e && 1 !== e.which && !this.touchMove) ||
        (this._unbindMouseMove(),
        this.connection ||
          (this.placeholderElement.parentNode.insertBefore(this.moving.getElement(), this.placeholderElement.nextSibling), this.placeholderElement.parentNode.removeChild(this.placeholderElement)),
        this.hoverElement.parentNode.removeChild(this.hoverElement),
        this.table.element.classList.remove('tabulator-block-select'),
    ...
    (N.prototype.connectToTables = function (e) {
      ...
      this.connectionSelectorsTables &&
        ((t = this.table.modules.comms.getConnections(this.connectionSelectorsTables)),
        this.table.options.movableRowsSendingStart.call(this.table, t),
        this.table.modules.comms.send(this.connectionSelectorsTables, 'moveRow', 'connect', { row: e })),
    ...
    (N.prototype.disconnectFromTables = function () {
      var e;
      this.connectionSelectorsTables &&
        ((e = this.table.modules.comms.getConnections(this.connectionSelectorsTables)),
    ...
    (N.prototype.dropComplete = function (e, t, o) {
      ...
      if (o) {
        ...
        i
          ? i.call(this, this.moving.getComponent(), t ? t.getComponent() : void 0, e)
    ...
    (N.prototype.tableRowDrop = function (e, t) {
      ...
      o
        ? (i = o.call(this, this.connectedRow.getComponent(), t ? t.getComponent() : void 0, this.connectedTable))
        : console.warn('Mover Row Error - no matching receiver found:', this.table.options.movableRowsReceiver),
        i
          ? this.table.options.movableRowsReceived.call(this.table, this.connectedRow.getComponent(), t ? t.getComponent() : void 0, this.connectedTable)
          : this.table.options.movableRowsReceivedFailed.call(this.table, this.connectedRow.getComponent(), t ? t.getComponent() : void 0, this.connectedTable),
        this.table.modules.comms.send(this.connectedTable, 'moveRow', 'dropcomplete', { row: t, success: i });
    }),
  ...
  (B.prototype.initializeColumn = function (e) {
    ...
    this.allowedTypes.forEach(function (n) {
      ...
      e.definition[a] && (s = t.lookupMutator(e.definition[a])) && ((o = !0), (i[a] = { mutator: s, params: e.definition[a + 'Params'] || {} }));
    }),
    ...
    (B.prototype.transformRow = function (e, t, o) {
      ...
      return (
        this.enabled &&
          n.table.columnManager.traverse(function (n) {
            var a, r, l;
            n.modules.mutate &&
              (a = n.modules.mutate[s] || n.modules.mutate.mutator || !1) &&
              ((i = n.getFieldValue(void 0 !== o ? o : e)),
    ...
    (B.prototype.mutators = {}),
    d.prototype.registerModule('mutator', B);
  var O = function (e) {
    (this.table = e),
      (this.mode = 'local'),
      (this.progressiveLoad = !1),
  ...
  (O.prototype.createElements = function () {
    ...
    (O.prototype.generatePageSizeSelectList = function () {
      ...
      if (this.pageSizeSelect) {
        ...
        t.forEach(function (t) {
          ...
          (o.value = t),
            !0 === t
              ? e.table.modules.localize.bind('pagination|all', function (e) {
                  o.innerHTML = e;
                })
              : (o.innerHTML = t),
        ...
        (e = parseInt(e)),
          e > 0 && e <= t.max
            ? ((t.page = e),
              ...
              o.table.options.persistence && o.table.modExists('persistence', !0) && o.table.modules.persistence.config.page && o.table.modules.persistence.save('page'))
            : (console.warn('Pagination Error - Requested page is out of range of 1 - ' + t.max + ':', e), n());
      });
    }),
    ...
    (O.prototype._setPageButtons = function () {
      for (
        var e = this,
          ...
          n = this.page <= o ? Math.min(this.count, this.max) : Math.min(this.page + o, this.max);
        e.pagesElement.firstChild;

      )
        e.pagesElement.removeChild(e.pagesElement.firstChild);
      1 == e.page ? ((e.firstBut.disabled = !0), (e.prevBut.disabled = !0)) : ((e.firstBut.disabled = !1), (e.prevBut.disabled = !1)),
        e.page == e.max ? ((e.lastBut.disabled = !0), (e.nextBut.disabled = !0)) : ((e.lastBut.disabled = !1), (e.nextBut.disabled = !1));
      ...
      return new Promise(function (t, o) {
        e.page > 1
          ? (e.page--,
            ...
            e.table.options.persistence && e.table.modExists('persistence', !0) && e.table.modules.persistence.config.page && e.table.modules.persistence.save('page'))
      ...
      return new Promise(function (t, o) {
        e.page < e.max
          ? (e.page++,
            ...
            e.table.options.persistence && e.table.modExists('persistence', !0) && e.table.modules.persistence.config.page && e.table.modules.persistence.save('page'))
          : (e.progressiveLoad || console.warn('Pagination Error - Next page would be greater than maximum page of ' + e.max + ':', e.max + 1), o());
      });
    }),
    ...
    (O.prototype._getRemotePage = function () {
      ...
      return new Promise(function (n, s) {
        if (
          (i.table.modExists('ajax', !0) || s(),
          (e = d.prototype.helpers.deepClone(i.table.modules.ajax.getParams() || {})),
    ...
    (O.prototype._parseRemoteData = function (e) {
      var t,
        ...
        i = this;
      if (
        (void 0 === e[this.dataReceivedNames.last_page] && console.warn("Remote Pagination Error - Server response missing '" + this.dataReceivedNames.last_page + "' property"),
          ...
          switch (this.mode) {
            ...
            case 'progressive_scroll':
              (e = this.table.rowManager.getData().concat(e[this.dataReceivedNames.data])),
                ...
                i.table.rowManager.element.scrollHeight <= i.table.rowManager.element.clientHeight + o &&
                  i
                    .nextPage()
                    .then(function () {})
                    .catch(function () {});
    ...
    (O.prototype.footerRedraw = function () {
      ...
      Math.ceil(e.clientWidth) - e.scrollWidth < 0
        ...
        : ((this.pagesElement.style.display = ''), Math.ceil(e.clientWidth) - e.scrollWidth < 0 && (this.pagesElement.style.display = 'none'));
    }),
    (O.prototype.paginationDataSentNames = { page: 'page', size: 'size', sorters: 'sorters', filters: 'filters' }),
    (O.prototype.paginationDataReceivedNames = { current_page: 'current_page', last_page: 'last_page', data: 'data' }),
  ...
  (I.prototype.localStorageTest = function () {
    ...
    (I.prototype.initialize = function () {
      ...
      (this.mode = !0 !== t ? t : this.localStorageTest() ? 'local' : 'cookie'),
        ...
        this.config.page &&
          ...
          (void 0 === e.paginationSize || (!0 !== this.config.page && !this.config.page.size) || (this.table.options.paginationSize = e.paginationSize),
        ...
        this.config.group &&
          ...
          (void 0 === e.groupBy || (!0 !== this.config.group && !this.config.group.groupBy) || (this.table.options.groupBy = e.groupBy),
      ...
      return (
        ...
        t.forEach(function (t, n) {
          var s,
            a = o._findColumn(e, t);
          a &&
            (!0 === o.config.columns || void 0 == o.config.columns ? ((s = Object.keys(a)), s.push('width')) : (s = o.config.columns),
            s.forEach(function (e) {
              void 0 !== t[e] && (a[e] = t[e]);
            }),
    ...
    (I.prototype.getGroupConfig = function () {
      return (
        this.config.group &&
          ((!0 === this.config.group || this.config.group.groupBy) && (data.groupBy = this.table.options.groupBy),
          (!0 === this.config.group || this.config.group.groupStartOpen) && (data.groupStartOpen = this.table.options.groupStartOpen),
          (!0 === this.config.group || this.config.group.groupHeader) && (data.groupHeader = this.table.options.groupHeader)),
        data
      );
    }),
    (I.prototype.getPageConfig = function () {
      ...
      return (
        this.config.page &&
          ((!0 === this.config.page || this.config.page.size) && (e.paginationSize = this.table.modules.page.getPageSize()),
      ...
      return (
        e.forEach(function (e) {
          var i,
            ...
            s = e.getDefinition();
          e.isGroup
            ? ((n.title = s.title), (n.columns = t.parseColumns(e.getColumns())))
            : ((n.field = e.getField()),
              !0 === t.config.columns || void 0 == t.config.columns ? ((i = Object.keys(s)), i.push('width')) : (i = t.config.columns),
              i.forEach(function (t) {
                switch (t) {
                  case 'width':
                    n.width = e.getWidth();
  ...
  (j.prototype.initialize = function () {
    ...
    (j.prototype.cleanup = function () {
      document.body.classList.remove('tabulator-print-fullscreen-hide'),
        this.element && this.element.parentNode && (this.element.parentNode.removeChild(this.element), (this.table.element.style.display = ''));
    }),
    (j.prototype.printFullscreen = function (e, t, o) {
      ...
      (this.manualBlock = !0),
        ...
        this.table.options.printHeader &&
          (r.classList.add('tabulator-print-header'),
      ...
      Object.defineProperty(o.data, 'splice', {
        ...
        value: function () {
          ...
          if (!o.blocked && t === o.currentVersion) {
            if (
              (r &&
                ((i = !!e[s] && o.table.rowManager.getRowFromDataObject(e[s])),
                i
  ...
  (W.prototype.initializeColumn = function (e, t, o) {
    ...
    if (('header' === e && ((n = 'textarea' == t.definition.formatter || t.definition.variableHeight), (t.modules.resize = { variableHeight: n })), !0 === s || s == e)) {
      ...
      var c = function (e) {
        var o, n, s;
        (o = t.getFirstColumn()) &&
          ((n = i.table.columnManager.findColumnIndex(o)), (s = n > 0 && i.table.columnManager.getColumnByIndex(n - 1)) && i._checkResizability(s) && ((i.startColumn = t), i._mouseDown(e, s, r)));
      };
      r.addEventListener('mousedown', c),
        r.addEventListener('touchstart', c, { passive: !0 }),
        r.addEventListener('dblclick', function (e) {
          var o, n, s;
          (o = t.getFirstColumn()) &&
            ((n = i.table.columnManager.findColumnIndex(o)), (s = n > 0 && i.table.columnManager.getColumnByIndex(n - 1)) && i._checkResizability(s) && (e.stopPropagation(), s.reinitializeWidth(!0)));
        }),
        o.appendChild(a),
        o.appendChild(r);
    }
    ...
    (W.prototype._mouseDown = function (e, t, o) {
      function i(e) {
        t.setWidth(s.startWidth + ((void 0 === e.screenX ? e.touches[0].screenX : e.screenX) - s.startX)),
      ...
      s.table.element.classList.add('tabulator-block-select'),
        ...
        o.addEventListener('touchmove', i, { passive: !0 }),
  ...
  (G.prototype.initializeRow = function (e) {
    ...
    i.addEventListener('mousedown', s),
      i.addEventListener('touchstart', s, { passive: !0 }),
      n.addEventListener('click', function (e) {
        e.stopPropagation();
      });
    var a = function (o) {
  ...
  (U.prototype.initialize = function (e) {
    ...
    (this.tableHeight = i.element.clientHeight),
      ...
      i.element.parentNode && ((this.containerHeight = i.element.parentNode.clientHeight), (this.containerWidth = i.element.parentNode.clientWidth)),
      'undefined' != typeof ResizeObserver && 'virtual' === i.rowManager.getRenderMode()
        ? ((this.autoResize = !0),
          (this.observer = new ResizeObserver(function (e) {
            if (!i.browserMobile || (i.browserMobile && !i.modules.edit.currentCell)) {
              ...
              (o.tableHeight == t && o.tableWidth == n) ||
                ((o.tableHeight = t),
                (o.tableWidth = n),
                i.element.parentNode && ((o.containerHeight = i.element.parentNode.clientHeight), (o.containerWidth = i.element.parentNode.clientWidth)),
                i.redraw());
            }
          })),
            ...
            ((this.containerObserver = new ResizeObserver(function (e) {
              if (!i.browserMobile || (i.browserMobile && !i.modules.edit.currentCell)) {
                ...
                (o.containerHeight == t && o.containerWidth == n) ||
                  ((o.containerHeight = t), (o.containerWidth = n), (o.tableHeight = i.element.clientHeight), (o.tableWidth = i.element.clientWidth), i.redraw()),
                  i.redraw();
              }
            })),
  ...
  (Y.prototype.initialize = function () {
    ...
    (this.mode = this.table.options.responsiveLayout),
      ...
      this.table.columnManager.columnsByIndex.forEach(function (o, i) {
        o.modules.responsive &&
          ...
          ((o.modules.responsive.index = i), t.push(o), o.visible || 'collapse' !== e.mode || e.hiddenColumns.push(o));
      }),
      (t = t.reverse()),
    ...
    (Y.prototype.initializeRow = function (e) {
      ...
      'calc' !== e.type &&
        ...
        (e.modules.responsiveLayout = { element: t, open: this.collapseStartOpen }),
    ...
    (Y.prototype.showColumn = function (e) {
      ...
      e.show(!1, !0),
        ...
        'collapse' === this.mode &&
          ((t = this.hiddenColumns.indexOf(e)),
    ...
    (Y.prototype.generateCollapsedRowData = function (e) {
      var t,
        ...
        n = [];
      return (
        this.hiddenColumns.forEach(function (s) {
          var a = s.getFieldValue(i);
          s.definition.title &&
            s.field &&
            (s.modules.format && o.table.options.responsiveLayoutCollapseUseFormatters
              ? ((t = {
                  value: !1,
                  data: {},
                  getValue: function () {
                ...
                n.push({ title: s.definition.title, value: s.modules.format.formatter.call(o.table.modules.format, t, s.modules.format.params) }))
              ...
              ('click' === t.table.options.selectableRangeMode
                    ...
                    if (o.shiftKey) {
                      ...
                      o.ctrlKey || o.metaKey
                        ? (l.forEach(function (o) {
                          ...
                          (t.lastClickedRow = e))
                        : (t.deselectRows(void 0, !0), !0 !== t.table.options.selectable && l.length > t.table.options.selectable && (l = l.slice(0, t.table.options.selectable)), t.selectRows(l)),
                ...
                : (o.addEventListener('click', function (o) {
                  ...
                  o.addEventListener('mousedown', function (o) {
                    if (o.shiftKey)
                      return (
                        t.table._clearSelection(), (t.selecting = !0), (t.selectPrev = []), document.body.addEventListener('mouseup', i), document.body.addEventListener('keyup', i), t.toggleRow(e), !1
                      );
                  }),
                  o.addEventListener('mouseenter', function (o) {
  ...
  (X.prototype.initializeColumn = function (e, t) {
    ...
    (e.modules.sort = {
      ...
      (void 0 === e.definition.headerSort ? !1 !== this.table.options.headerSort : !1 !== e.definition.headerSort) &&
        ((o = e.getElement()),
        o.classList.add('tabulator-sortable'),
        (i = document.createElement('div')),
        i.classList.add('tabulator-arrow'),
        t.appendChild(i),
        o.addEventListener('click', function (t) {
          ...
          if (e.modules.sort) {
            ...
            n.table.options.columnHeaderSortMulti && (t.shiftKey || t.ctrlKey)
              ? ((i = n.getSort()),
                (s = i.findIndex(function (t) {
                  return t.field === e.getField();
                })),
                s > -1 ? ((i[s].dir = o), s != i.length - 1 && ((s = i.splice(s, 1)[0]), 'none' != o && i.push(s))) : 'none' != o && i.push({ column: e, dir: o }),
                n.setSort(i))
              : 'none' == o
              ? n.clear()
              : n.setSort(e, o),
      ...
      t.table.options.dataSorting && t.table.options.dataSorting.call(t.table, t.getSort()),
        ...
        t.table.options.ajaxSorting
          ...
          : (o.forEach(function (e, o) {
              ...
              e.column && n && (n.sorter || (n.sorter = t.findSorter(e.column)), (e.params = 'function' == typeof n.params ? n.params(e.column.getComponent(), e.dir) : n.params), i.push(e)),
                t.setColumnHeader(e.column, e.dir);
            }),
    ...
    (X.prototype.sorters = {
      number: function (e, t, o, i, n, s, a) {
        var r = a.alignEmptyValues,
          ...
          u = 0;
        if (((e = parseFloat(String(e).split(c).join('').split(l).join('.'))), (t = parseFloat(String(t).split(c).join('').split(l).join('.'))), isNaN(e))) u = isNaN(t) ? 0 : -1;
        else {
  ...
  return (
    ...
    (K.prototype._buildValidator = function (e, t) {
      ...
      return o ? { type: 'function' == typeof e ? 'function' : e, func: o, params: t } : (console.warn('Validator Setup Error - No matching validator found:', e), !1);
    }),
    (K.prototype.validate = function (e, t, o) {
      ...
      return (
        ...
        !0 === n
          ? ((t.modules.validate.invalid = !1), t.getElement().classList.remove('tabulator-validation-fail'), s > -1 && this.invalidCells.splice(s, 1))
          : ((t.modules.validate.invalid = !0), 'manual' !== this.table.options.validationMode && t.getElement().classList.add('tabulator-validation-fail'), -1 == s && this.invalidCells.push(t)),
        n
      );
    }),
    ...
    (K.prototype.clearValidation = function (e) {
      ...
      e.modules.validate &&
        ...
        (e.element.classList.remove('tabulator-validation-fail'), (e.modules.validate.invalid = !1), (t = this.invalidCells.indexOf(e)) > -1 && this.invalidCells.splice(t, 1));
    }),
    ...
    d.prototype.registerModule('validate', K),
    d
  );
});
